...
Las ciudades modernas requieren sistemas de tráfico inteligentes para optimizar el flujo vehicular y garantizar la seguridad vial. Su equipo ha sido contratado para desarrollar el núcleo lógico de un sistema embebido que controlará semáforos en intersecciones críticas de la ciudad.

## 🔻 Objetivos
- Traducir los requisitos funcionales de un sistema de tráfico urbano a código LISP utilizando paradigmas de programacion funcional.
- Implementar funciones puras, inmutabilidad y composicion funcional.
- Evaluar y tipificar las funciones creadas, comprendiendo sus implicancias en la memoria y el flujo de datos, y comparar como CLOJURE "en este caso", aborda el mismo problema lógico.
...
- 🔴 (VIDEO YOUTUBE) Demo Tecnica:(https://m.youtube.com/watch?v=OP6mAwoTF9s)
